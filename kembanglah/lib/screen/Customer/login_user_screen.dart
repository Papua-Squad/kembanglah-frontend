...
import 'package:kembanglah/screen/Customer/regist_user_screen.dart';

class LoginUserScreen extends StatefulWidget {
  @override
  _LoginUserScreen createState() => _LoginUserScreen();
}

class _LoginUserScreen extends State<LoginUserScreen> {
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>
                                          HomeUserScreen()), (Route<dynamic> route) => false);
                                    },
                                    child: Text(
                                      'LOGIN',
                                      style: TextStyle(),
                              ...
                              Center(
                                child: TextButton(
                                    onPressed: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => RegistUserScreen()));
                                    },
                                    child: Text(
                                      "Sign Up",
                                      style: TextStyle(
